/* =============================================================================
   COMPONENT: PreviewEngine — the logo mark, the "Foundation" tag, and the
   engine that renders each component's live preview from its real captured
   specs.json. Find this file if you need to change how a component's live
   preview is drawn.
============================================================================= */
...
export function Mark({ size = 22 }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path
        d="M12 1.5 L21.5 6.75 V17.25 L12 22.5 L2.5 17.25 V6.75 Z"
        fill={R ? R.yellow : "#FFE600"}
        stroke={R ? R.black : "#000"}
        strokeWidth="1"
      />
    </svg>
  );
...
export function DotPattern() {
  return (
    <svg width="100%" height="100%" style={{ opacity: 0.4, position: "absolute", top: 0, left: 0 }}>
      <defs>
        <pattern id="apy-dots" x="0" y="0" width="26" height="26" patternUnits="userSpaceOnUse">
          <circle cx="1.5" cy="1.5" r="1.5" fill="#E2E0D8" />
        </pattern>
      </defs>
...
export function ComponentPreview({ item }) {
